...
export default class CustomButton extends Component {
    render() {
        return (
            <TouchableOpacity style={{marginRight:this.props.marginRight, marginLeft:this.props.marginLeft ,justifyContent: 'center',width:this.props.width && this.props.width,borderColor:this.props.borderColor && this.props.borderColor,borderWidth:this.props.borderWidth && this.props.borderWidth ,borderRadius:this.props.borderRadius,padding:5,marginTop:this.props.marginTop? this.props.marginTop :20,height: this.props.height ? this.props.height : 40, backgroundColor: this.props.backgroundColor ? this.props.backgroundColor : Colors.buttonBackgroundColor,}} onPress={this.props.onPress}>
