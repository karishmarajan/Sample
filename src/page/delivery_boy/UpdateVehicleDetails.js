...
export default class UpdateVehicleDetails extends React.Component {
...
{/*//////////////////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <Navbar left={left} title="Update Details" />
...
<View style={{ backgroundColor:Colors.white,flexGrow:1,padding:MAIN_VIEW_PADDING}}>
      ...
      <CustomButton title={'Update'} backgroundColor={Colors.darkSkyBlue} onPress={()=>this.add_vehicle()} />
