    ...
    render(){
      var left = (
        ...
        return(
          ...
          <Container>
        <Navbar left={left} title="Notification" />
...
<View style={{flexDirection:'row'}}>
    <View style={{ flex: 9 }}><CustomText text={'Lorem'} textType={Strings.subtext} fontWeight={'bold'}/></View>
    <View style={{ flex: 1, marginLeft: SECTION_MARGIN_TOP, marginTop:10 }}><Icon name={'ios-arrow-forward'} style={{color:Colors.darkSkyBlue,fontSize:16,flex:1,}} /></View>
</View>
