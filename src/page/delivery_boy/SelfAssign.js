...
render(){
    ...
    return(
      <Container>
        ...
        <CustomButton title={'Barcode Scan'} backgroundColor={Colors.darkSkyBlue} width={120} height={30} fontSize={16} marginTop={10} />

        {/*////////////////////// Selecting Order id Block //////////////////////////////////////////////// */}

<View style={{marginTop:10}}>
        <CustomText text={'Enter Order Id'} textType={Strings.maintext}/>
        <View style={{borderWidth:1,borderColor:Colors.borderColor,height:45,marginRight:10,flexDirection:'row',borderRadius:5,paddingTop:2}}>
